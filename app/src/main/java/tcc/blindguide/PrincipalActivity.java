...
import tcc.fragments.RotaFragment;
import tcc.fragments.LaunchpadSectionFragment;
import tcc.fragments.LaunchpadSectionNavigationFragment;
...
public class PrincipalActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            switch (i) {
                case 0:
                    return new LaunchpadSectionNavigationFragment();
                case 1:
                    return new LaunchpadSectionFragment(new RotaFragment());
    ...
    public static class DummySectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return rootView; */
            TextView _tt = new TextView(this.getActivity());
            _tt.setText("22");
